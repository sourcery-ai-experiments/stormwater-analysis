...
import pytest
import numpy as np
from pipes.round import (check_dimensions, max_filling, max_velocity, min_velocity,
                         calc_f, calc_u, calc_rh, min_slope, max_slope)
...
class TestCalcRh:
    ...
    @pytest.mark.parametrize("filling, diameter, expected", [
        (1.0, 0.5, ValueError),
        (0.3, 0.3, 0.075),
        (0.5, 1.0, 0.25),
        (2.5, 1.0, ValueError),
